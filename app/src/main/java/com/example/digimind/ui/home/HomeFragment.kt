        ...
        storage.collection("actividades")
            ...
            .addOnSuccessListener {
                it.forEach{
                    ...
                    if(it.getBoolean("lun")==true){
                        dias.add("Monday")
                    }
                    if(it.getBoolean("mar")==true){
                        dias.add("Tuesday")
                    }
                    if(it.getBoolean("mie")==true){
                        dias.add("Wednesday")
                    }
                    if(it.getBoolean("jue")==true){
                        dias.add("Thursday")
                    }
                    if(it.getBoolean("vie")==true){
                        dias.add("Friday")
                    }
                    if(it.getBoolean("sab")==true){
                        dias.add("Saturday")
                    }
                    if(it.getBoolean("dom")==true){
                        dias.add("Sunday")
                    }
